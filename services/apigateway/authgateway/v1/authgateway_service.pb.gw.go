...
func request_AuthGatewayService_Register_0(ctx context.Context, marshaler runtime.Marshaler, client AuthGatewayServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_AuthGatewayService_Register_0(ctx context.Context, marshaler runtime.Marshaler, server AuthGatewayServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RegisterRequest
	var metadata runtime.ServerMetadata
...
func RegisterAuthGatewayServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AuthGatewayServiceServer) error {
	...
	mux.Handle("POST", pattern_AuthGatewayService_Register_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_AuthGatewayService_Register_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_AuthGatewayService_Register_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAuthGatewayServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AuthGatewayServiceClient) error {
	...
	mux.Handle("POST", pattern_AuthGatewayService_Register_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AuthGatewayService_Register_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	forward_AuthGatewayService_Register_0 = runtime.ForwardResponseMessage
