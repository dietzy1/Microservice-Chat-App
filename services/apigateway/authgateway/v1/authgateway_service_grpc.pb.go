...
const (
	AuthGatewayService_Login_FullMethodName        = "/authgateway.v1.AuthGatewayService/Login"
	AuthGatewayService_Logout_FullMethodName       = "/authgateway.v1.AuthGatewayService/Logout"
	AuthGatewayService_Authenticate_FullMethodName = "/authgateway.v1.AuthGatewayService/Authenticate"
)
...
func (c *authGatewayServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthGatewayService_Login_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authGatewayServiceClient) Logout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*LogoutResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthGatewayService_Logout_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authGatewayServiceClient) Authenticate(ctx context.Context, in *AuthenticateRequest, opts ...grpc.CallOption) (*AuthenticateResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthGatewayService_Authenticate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthGatewayService_Authenticate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthGatewayService_Authenticate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
