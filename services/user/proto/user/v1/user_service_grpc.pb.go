...
const (
	...
	UserService_AddChatServer_FullMethodName    = "/user.v1.UserService/AddChatServer"
	UserService_RemoveChatServer_FullMethodName = "/user.v1.UserService/RemoveChatServer"
	UserService_GetUser_FullMethodName          = "/user.v1.UserService/GetUser"
	UserService_GetUsers_FullMethodName         = "/user.v1.UserService/GetUsers"
	UserService_EditDescription_FullMethodName  = "/user.v1.UserService/EditDescription"
	UserService_ChangeAvatar_FullMethodName     = "/user.v1.UserService/ChangeAvatar"
)
...
func (c *userServiceClient) AddChatServer(ctx context.Context, in *AddChatServerRequest, opts ...grpc.CallOption) (*AddChatServerResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_AddChatServer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) RemoveChatServer(ctx context.Context, in *RemoveChatServerRequest, opts ...grpc.CallOption) (*RemoveChatServerResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_RemoveChatServer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) EditDescription(ctx context.Context, in *EditDescriptionRequest, opts ...grpc.CallOption) (*EditDescriptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_EditDescription_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_AddChatServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_AddChatServer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_RemoveChatServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_RemoveChatServer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_EditDescription_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_EditDescription_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
