...
var file_user_v1_user_service_proto_rawDesc = []byte{
	...
	0x05, 0x69, 0x63, 0x6f, 0x6e, 0x73, 0x32, 0xc7, 0x05, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53,
	...
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x41, 0x0a, 0x08,
	...
	0x56, 0x0a, 0x0f, 0x45, 0x64, 0x69, 0x74, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x1f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x64, 0x69,
	0x74, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x64,
	0x69, 0x74, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x4d, 0x0a, 0x0c, 0x43, 0x68, 0x61, 0x6e, 0x67,
	...
	,
...
var file_user_v1_user_service_proto_goTypes = []interface{}{
	...
	(*ImageInfo)(nil),                // 17: user.v1.ImageInfo
	(*GetAvatarsRequest)(nil),        // 18: user.v1.GetAvatarsRequest
	(*GetAvatarsResponse)(nil),       // 19: user.v1.GetAvatarsResponse
}
var file_user_v1_user_service_proto_depIdxs = []int32{
	...
	17, // 2: user.v1.UploadAvatarRequest.info:type_name -> user.v1.ImageInfo
	14, // 3: user.v1.GetAvatarsResponse.icons:type_name -> user.v1.Icon
	0,  // 4: user.v1.UserService.CreateUser:input_type -> user.v1.CreateUserRequest
	2,  // 5: user.v1.UserService.AddChatServer:input_type -> user.v1.AddChatServerRequest
	4,  // 6: user.v1.UserService.RemoveChatServer:input_type -> user.v1.RemoveChatServerRequest
	6,  // 7: user.v1.UserService.GetUser:input_type -> user.v1.GetUserRequest
	8,  // 8: user.v1.UserService.GetUsers:input_type -> user.v1.GetUsersRequest
	10, // 9: user.v1.UserService.EditDescription:input_type -> user.v1.EditDescriptionRequest
	12, // 10: user.v1.UserService.ChangeAvatar:input_type -> user.v1.ChangeAvatarRequest
	18, // 11: user.v1.UserService.GetAvatars:input_type -> user.v1.GetAvatarsRequest
	15, // 12: user.v1.UserService.UploadAvatar:input_type -> user.v1.UploadAvatarRequest
	1,  // 13: user.v1.UserService.CreateUser:output_type -> user.v1.CreateUserResponse
	3,  // 14: user.v1.UserService.AddChatServer:output_type -> user.v1.AddChatServerResponse
	5,  // 15: user.v1.UserService.RemoveChatServer:output_type -> user.v1.RemoveChatServerResponse
	7,  // 16: user.v1.UserService.GetUser:output_type -> user.v1.GetUserResponse
	9,  // 17: user.v1.UserService.GetUsers:output_type -> user.v1.GetUsersResponse
	11, // 18: user.v1.UserService.EditDescription:output_type -> user.v1.EditDescriptionResponse
	13, // 19: user.v1.UserService.ChangeAvatar:output_type -> user.v1.ChangeAvatarResponse
	19, // 20: user.v1.UserService.GetAvatars:output_type -> user.v1.GetAvatarsResponse
	16, // 21: user.v1.UserService.UploadAvatar:output_type -> user.v1.UploadAvatarResponse
...
func file_user_v1_user_service_proto_init() {
	...
	file_user_v1_user_service_proto_msgTypes[15].OneofWrappers = []interface{}{
